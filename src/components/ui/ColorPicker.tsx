        ...
        >
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1">
              <span className="absolute left-2 top-1/2 -translate-y-1/2 text-sm text-text-muted font-mono">#</span>
              <input
                type="text"
                value={hexDraft}
            ...
            <div className="relative w-16">
              ...
              />
              <span className="absolute right-2 top-1/2 -translate-y-1/2 text-sm text-text-muted font-mono">%</span>
            </div>
          </div>
          {isCustom && (
            <button
